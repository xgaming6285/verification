...
class GeolocationDetector {
  ...
  async detectCountry() {
    ...
    for (let i = 1; i < this.ipServices.length; i++) {
      try {
        ...
        console.warn(
          `IP service ${this.ipServices[i].name} failed:`,
          error.message
        );
        continue;
      }
    ...
    try {
      const countryCode = await this.tryBrowserGeolocation();
      if (countryCode) {
        this.detectedCountryCode = countryCode;
      }
      return countryCode;
  ...
  /**
   * Get the detected country code (uppercase)
   */
  getDetectedCountryCode() {
    return this.detectedCountryCode
      ? this.detectedCountryCode.toUpperCase()
      : null;
  }
  ...
  getLanguageForCountry(countryCode) {
    ...
    // Bulgarian-speaking countries and regions with significant Bulgarian population
    const bulgarianCountries = [
      "bg", // Bulgaria
      "mk", // North Macedonia (Bulgarian minority)
      "md", // Moldova (Bulgarian minority in Bessarabia)
      "rs", // Serbia (Bulgarian minority)
      "ro", // Romania (Bulgarian minority)
      "ua", // Ukraine (Bulgarian minority)
      "gr", // Greece (Bulgarian minority in Thrace)
      "tr", // Turkey (Bulgarian minority)
      "al", // Albania (Bulgarian minority)
      "xk", // Kosovo (Bulgarian minority)
      "me", // Montenegro (Bulgarian minority)
      "ba", // Bosnia and Herzegovina (Bulgarian community)
      "hr", // Croatia (Bulgarian community)
      "si", // Slovenia (Bulgarian community)
      "hu", // Hungary (Bulgarian community)
      "sk", // Slovakia (Bulgarian community)
      "cz", // Czech Republic (Bulgarian community)
      "pl", // Poland (Bulgarian community)
      "at", // Austria (Bulgarian community)
      "cy", // Cyprus (Bulgarian community)
    ];
    ...
    const spanishCountries = [
      ...
      "pr", // Puerto Rico
      "ad", // Andorra (Spanish widely spoken)
      "bz", // Belize (Spanish widely spoken)
      "gi", // Gibraltar (Spanish widely spoken)
      "aw", // Aruba (Spanish widely spoken)
      "cw", // Curaçao (Spanish widely spoken)
      "sx", // Sint Maarten (Spanish widely spoken)
      "bq", // Caribbean Netherlands (Spanish spoken)
      "mf", // Saint Martin (Spanish spoken)
      "tc", // Turks and Caicos (Spanish spoken)
      "ky", // Cayman Islands (Spanish spoken)
      "vg", // British Virgin Islands (Spanish spoken)
      "vi", // US Virgin Islands (Spanish spoken)
      "tt", // Trinidad and Tobago (Spanish spoken)
      "ht", // Haiti (Spanish understood)
      "jm", // Jamaica (Spanish understood)
      "bb", // Barbados (Spanish understood)
      "lc", // Saint Lucia (Spanish understood)
      "gd", // Grenada (Spanish understood)
      "dm", // Dominica (Spanish understood)
      "ag", // Antigua and Barbuda (Spanish understood)
      "kn", // Saint Kitts and Nevis (Spanish understood)
      "vc", // Saint Vincent and the Grenadines (Spanish understood)
      "gp", // Guadeloupe (Spanish understood)
      "mq", // Martinique (Spanish understood)
      "gy", // Guyana (Spanish understood)
      "sr", // Suriname (Spanish understood)
      "gf", // French Guiana (Spanish understood)
      "ph", // Philippines (Spanish heritage, understood)
    ...
    if (spanishCountries.includes(countryCode)) {
      console.log(
        `Detected Spanish-speaking country: ${countryCode.toUpperCase()}`
      );
      return this.spanishLanguage;
    }

    console.log(
      `Detected non-supported country: ${countryCode.toUpperCase()}, defaulting to English`
    );
    return this.defaultLanguage;
  }
